...
--
-- Name: dvdrental; Type: DATABASE; Schema: -; Owner: user
--

CREATE DATABASE dvdrental WITH TEMPLATE = template0 ENCODING = 'UTF8';


ALTER DATABASE dvdrental OWNER TO "user";
...
--
-- Name: mpaa_rating; Type: TYPE; Schema: public; Owner: user
--
...
--
-- Name: year; Type: DOMAIN; Schema: public; Owner: user
--
...
--
-- Name: _group_concat(text, text); Type: FUNCTION; Schema: public; Owner: user
--
...
ALTER FUNCTION public._group_concat(text, text) OWNER TO "user";

--
-- Name: film_in_stock(integer, integer); Type: FUNCTION; Schema: public; Owner: user
--
...
ALTER FUNCTION public.film_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO "user";

--
-- Name: film_not_in_stock(integer, integer); Type: FUNCTION; Schema: public; Owner: user
--
...
ALTER FUNCTION public.film_not_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO "user";

--
-- Name: get_customer_balance(integer, timestamp without time zone); Type: FUNCTION; Schema: public; Owner: user
--
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamp without time zone) OWNER TO "user";

--
-- Name: inventory_held_by_customer(integer); Type: FUNCTION; Schema: public; Owner: user
--
...
ALTER FUNCTION public.inventory_held_by_customer(p_inventory_id integer) OWNER TO "user";

--
-- Name: inventory_in_stock(integer); Type: FUNCTION; Schema: public; Owner: user
--
...
ALTER FUNCTION public.inventory_in_stock(p_inventory_id integer) OWNER TO "user";

--
-- Name: last_day(timestamp without time zone); Type: FUNCTION; Schema: public; Owner: user
--
...
ALTER FUNCTION public.last_day(timestamp without time zone) OWNER TO "user";

--
-- Name: last_updated(); Type: FUNCTION; Schema: public; Owner: user
--
...
--
-- Name: customer_customer_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
--
-- Name: rewards_report(integer, numeric); Type: FUNCTION; Schema: public; Owner: user
--
...
ALTER FUNCTION public.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO "user";

--
-- Name: group_concat(text); Type: AGGREGATE; Schema: public; Owner: user
--
...
ALTER AGGREGATE public.group_concat(text) OWNER TO "user";
...
--
-- Name: film_actor; Type: TABLE; Schema: public; Owner: user
--
...
--
-- Name: film_category; Type: TABLE; Schema: public; Owner: user
--
...
--
-- Name: actor_info; Type: VIEW; Schema: public; Owner: user
--
...
ALTER TABLE public.actor_info OWNER TO "user";

--
-- Name: address_address_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
--
-- Name: city_city_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
--
-- Name: country_country_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
--
-- Name: customer_list; Type: VIEW; Schema: public; Owner: user
--
...
ALTER TABLE public.customer_list OWNER TO "user";

--
-- Name: film_list; Type: VIEW; Schema: public; Owner: user
--
...
ALTER TABLE public.film_list OWNER TO "user";

--
-- Name: inventory_inventory_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
--
-- Name: language_language_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
--
-- Name: language; Type: TABLE; Schema: public; Owner: user
--
...
--
-- Name: nicer_but_slower_film_list; Type: VIEW; Schema: public; Owner: user
--
...
ALTER TABLE public.nicer_but_slower_film_list OWNER TO "user";
...
--
-- Name: rental_rental_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
--
-- Name: rental; Type: TABLE; Schema: public; Owner: user
--
...
--
-- Name: sales_by_film_category; Type: VIEW; Schema: public; Owner: user
--
...
ALTER TABLE public.sales_by_film_category OWNER TO "user";

--
-- Name: staff_staff_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
--
-- Name: store_store_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
--
-- Name: sales_by_store; Type: VIEW; Schema: public; Owner: user
--
...
ALTER TABLE public.sales_by_store OWNER TO "user";

--
-- Name: staff_list; Type: VIEW; Schema: public; Owner: user
--
...
ALTER TABLE public.staff_list OWNER TO "user";
...
\.
COPY public.actor (actor_id, first_name, last_name, last_update) FROM '/app/data/dvdrental/3057.dat';
...
\.
COPY public.address (address_id, address, address2, district, city_id, postal_code, phone, last_update) FROM '/app/data/dvdrental/3065.dat';
...
\.
COPY public.category (category_id, name, last_update) FROM '/app/data/dvdrental/3059.dat';
...
\.
COPY public.city (city_id, city, country_id, last_update) FROM '/app/data/dvdrental/3067.dat';
...
\.
COPY public.country (country_id, country, last_update) FROM '/app/data/dvdrental/3069.dat';
...
\.
COPY public.customer (customer_id, store_id, first_name, last_name, email, address_id, activebool, create_date, last_update, active) FROM '/app/data/dvdrental/3055.dat';
...
\.
COPY public.film (film_id, title, description, release_year, language_id, rental_duration, rental_rate, length, replacement_cost, rating, last_update, special_features, fulltext) FROM '/app/data/dvdrental/3061.dat';

--
-- Data for Name: film_actor; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.film_actor (actor_id, film_id, last_update) FROM stdin;
\.
COPY public.film_actor (actor_id, film_id, last_update) FROM '/app/data/dvdrental/3062.dat';

--
-- Data for Name: film_category; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.film_category (film_id, category_id, last_update) FROM stdin;
\.
COPY public.film_category (film_id, category_id, last_update) FROM '/app/data/dvdrental/3063.dat';
...
\.
COPY public.inventory (inventory_id, film_id, store_id, last_update) FROM '/app/data/dvdrental/3071.dat';

--
-- Data for Name: language; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.language (language_id, name, last_update) FROM stdin;
\.
COPY public.language (language_id, name, last_update) FROM '/app/data/dvdrental/3073.dat';
...
\.
COPY public.payment (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '/app/data/dvdrental/3075.dat';

--
-- Data for Name: rental; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM stdin;
\.
COPY public.rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM '/app/data/dvdrental/3077.dat';
...
\.
COPY public.staff (staff_id, first_name, last_name, address_id, email, store_id, active, username, password, last_update, picture) FROM '/app/data/dvdrental/3079.dat';
...
\.
COPY public.store (store_id, manager_staff_id, address_id, last_update) FROM '/app/data/dvdrental/3081.dat';
...
--
-- Name: address_address_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: city_city_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: country_country_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: customer_customer_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: inventory_inventory_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: language_language_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: rental_rental_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: staff_staff_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: store_store_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--
...
--
-- Name: film_actor film_actor_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: film_category film_category_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: language language_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: rental rental_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: film_fulltext_idx; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_actor_last_name; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_fk_address_id; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_fk_city_id; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_fk_country_id; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_fk_customer_id; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_fk_film_id; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_fk_inventory_id; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_fk_language_id; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_fk_rental_id; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_fk_staff_id; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_fk_store_id; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_last_name; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_store_id_film_id; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_title; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_unq_manager_staff_id; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: idx_unq_rental_rental_date_inventory_id_customer_id; Type: INDEX; Schema: public; Owner: user
--
...
--
-- Name: film film_fulltext_trigger; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: actor last_updated; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: address last_updated; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: category last_updated; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: city last_updated; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: country last_updated; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: customer last_updated; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: film last_updated; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: film_actor last_updated; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: film_category last_updated; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: inventory last_updated; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: language last_updated; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: rental last_updated; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: staff last_updated; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: store last_updated; Type: TRIGGER; Schema: public; Owner: user
--
...
--
-- Name: customer customer_address_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: film_actor film_actor_actor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: film_actor film_actor_film_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: film_category film_category_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: film_category film_category_film_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: film film_language_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: address fk_address_city; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: city fk_city; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: inventory inventory_film_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: payment payment_rental_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: payment payment_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: rental rental_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: rental rental_inventory_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: rental rental_staff_id_key; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: staff staff_address_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: store store_address_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
...
--
-- Name: store store_manager_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: user
--
